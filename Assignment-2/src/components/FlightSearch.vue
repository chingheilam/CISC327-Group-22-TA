        ...
        <div class="action-buttons">
            <div class="action-button-container">
                <t-button class="action-button">
                    <img src="/Reschedule.png" alt="Reschedule Icon" class="action-icon" />
                    <span>Reschedule</span>
                </t-button>
                <t-divider layout="vertical" />

                <t-button class="action-button">
                    <img src="/Upgrade.png" alt="Upgrade Icon" class="action-icon" />
                    <span>Upgrade Class</span>
                </t-button>
                <t-divider layout="vertical" />

                <t-button class="action-button">
                    <img src="/Cancel.png" alt="Refund Icon" class="action-icon" />
                    <span>Refund Ticket</span>
                </t-button>
                <t-divider layout="vertical" />

                <t-button class="action-button">
                    <img src="/Check-in.png" alt="Check-in Icon" class="action-icon" />
                    <span>Check-in</span>
                </t-button>
            </div>
        </div>
...
.search-container {
    text-align: center;
    background-image: url('/Users/lamchinghei/General/Queens/Year 3 - Fall/CISC327/A2/Assignment2/frontend/public/background.png');
